...
const ACCESSIBILITY_EN = {
  ...
  targetFoundMessage: 'You have been taken to the main section',
  ...
  gotoContact: 'Go to main section',
...
function applyHomeStaticCopy() {
  ...
  setTexts('#navLinks a', ['Services', 'About Us', 'Gallery', 'Samples', 'How To Order', 'Vehicle Types', 'Service Areas', 'Reviews', 'Order Now']);
