...
function getSamplesCatalogUiText() {
  ...
  if (isEnglish) {
    return {
      ...
      total: total => `Showing all ${total} samples`,
      range: (from, to, total) => `Showing ${from}-${to} of ${total} samples`,
      page: page => `Page ${page}`,
      prev: 'Previous page',
      next: 'Next page'
    };
  ...
  return {
    empty: 'কোনো স্যাম্পল পাওয়া যায়নি',
    total: total => `মোট ${total} টি স্যাম্পল দেখানো হচ্ছে`,
